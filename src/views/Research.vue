...
<template>
        ...
        <div class="main-column">
          ...
          <section class="articles-section section-container">
            ...
            <div class="filter-bar">
              ...
              <el-input v-model="searchQuery" placeholder="搜索文章..." prefix-icon="Search" size="small" class="search-input" />
            </div>
            <div class="articles-container">
              <div class="article-card" v-for="article in articles" :key="article.id">
                ...
                <div class="article-cover">
                  ...
                  <span class="article-tag">{{ article.tags }}</span>
                </div>
            ...
            <div class="pagination-container">
              <el-pagination background layout="prev, pager, next" :total="paginationData.total" :page-size="paginationData.pageSize" />
            </div>
          </section>
            ...
            <ul class="timeline-compact">
              <li class="timeline-item" v-for="item in researchTimeline" :key="item.id">
                ...
                <div class="timeline-content">
                  ...
                  <el-button v-if="item.isButton" text type="primary" size="small">{{ item.buttonText }}</el-button>
                </div>
              </li>
            </ul>
          </section>
  ...
  <!-- 底部版权和备案信息 -->
  <Footer />
  <el-image class="bg-image" :src="bgUrl" :fit="'cover'" draggable="false" :class="{ 'dim-bg': currentTheme === 'dark' }" />
</template>

<script setup>
import { ref, onMounted, onUnmounted } from 'vue'
import { Document, Calendar, ArrowRight, Search, Link, Collection, Tools, Reading, ChatDotRound, Connection, Edit, Operation, School, VideoPlay, Notebook, Platform, Timer } from '@element-plus/icons-vue'
